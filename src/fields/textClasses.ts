...
export const textClasses: textClassesType = ({ condition = () => true, overrides = {} } = {}) => {
  const textResult: Field = {
    ...
    options: [
      ...
      { label: 'Text Size - XS', value: 'text-xs' },
      { label: 'Text Size - SM', value: 'text-sm' },
      { label: 'Text Size - Base', value: 'text-base' },
      { label: 'Text Size - LG', value: 'text-lg' },
      { label: 'Text Size - XL', value: 'text-xl' },
      { label: 'Text Size - 2XL', value: 'text-2xl' },
      ...
      { label: 'Text Size - 9XL', value: 'text-9xl' },
      { label: 'Text Size - 10XL', value: 'text-10xl' },
      { label: 'Text Size - 11XL', value: 'text-11xl' },
      { label: 'Text Size - 12XL', value: 'text-12xl' },
      { label: 'Text Size - 13XL', value: 'text-13xl' },
      { label: 'Margin Top - (-8XL)', value: '-mt-40' },
      { label: 'Margin Top - (-7XL)', value: '-mt-32' },
      { label: 'Margin Top - (-6XL)', value: '-mt-24' },
      { label: 'Margin Top - (-5XL)', value: '-mt-20' },
      { label: 'Margin Top - (-4XL)', value: '-mt-16' },
      { label: 'Margin Top - (-3XL)', value: '-mt-12' },
      { label: 'Margin Top - (-2XL)', value: '-mt-10' },
      { label: 'Margin Top - (-XL)', value: '-mt-8' },
      { label: 'Margin Top - (-L)', value: '-mt-6' },
      { label: 'Margin Top - (-M)', value: '-mt-4' },
      { label: 'Margin Top - (-S)', value: '-mt-2' },
      { label: 'Margin Top - (-XS)', value: '-mt-1' },
      { label: 'Margin Top - None', value: 'mt-0' },
      { label: 'Margin Top - XS', value: 'mt-1' },
      { label: 'Margin Top - S', value: 'mt-2' },
      { label: 'Margin Top - M', value: 'mt-4' },
      { label: 'Margin Top - L', value: 'mt-6' },
      ...
      { label: 'Margin Top - 7XL', value: 'mt-32' },
      { label: 'Margin Top - 8XL', value: 'mt-40' },
      { label: 'MD Margin Top - (-8XL)', value: 'md:-mt-40' },
      { label: 'MD Margin Top - (-7XL)', value: 'md:-mt-32' },
      { label: 'MD Margin Top - (-6XL)', value: 'md:-mt-24' },
      { label: 'MD Margin Top - (-5XL)', value: 'md:-mt-20' },
      { label: 'MD Margin Top - (-4XL)', value: 'md:-mt-16' },
      { label: 'MD Margin Top - (-3XL)', value: 'md:-mt-12' },
      { label: 'MD Margin Top - (-2XL)', value: 'md:-mt-10' },
      { label: 'MD Margin Top - (-XL)', value: 'md:-mt-8' },
      { label: 'MD Margin Top - (-L)', value: 'md:-mt-6' },
      { label: 'MD Margin Top - (-M)', value: 'md:-mt-4' },
      { label: 'MD Margin Top - (-S)', value: 'md:-mt-2' },
      { label: 'MD Margin Top - (-XS)', value: 'md:-mt-1' },
      { label: 'MD Margin Top - None', value: 'md:mt-0' },
      { label: 'MD Margin Top - XS', value: 'md:mt-1' },
      { label: 'MD Margin Top - S', value: 'md:mt-2' },
      { label: 'MD Margin Top - M', value: 'md:mt-4' },
      { label: 'MD Margin Top - L', value: 'md:mt-6' },
      ...
      { label: 'MD Margin Top - 7XL', value: 'md:mt-32' },
      { label: 'MD Margin Top - 8XL', value: 'md:mt-40' },
      { label: 'LG Margin Top - (-8XL)', value: 'lg:-mt-40' },
      { label: 'LG Margin Top - (-7XL)', value: 'lg:-mt-32' },
      { label: 'LG Margin Top - (-6XL)', value: 'lg:-mt-24' },
      { label: 'LG Margin Top - (-5XL)', value: 'lg:-mt-20' },
      { label: 'LG Margin Top - (-4XL)', value: 'lg:-mt-16' },
      { label: 'LG Margin Top - (-3XL)', value: 'lg:-mt-12' },
      { label: 'LG Margin Top - (-2XL)', value: 'lg:-mt-10' },
      { label: 'LG Margin Top - (-XL)', value: 'lg:-mt-8' },
      { label: 'LG Margin Top - (-L)', value: 'lg:-mt-6' },
      { label: 'LG Margin Top - (-M)', value: 'lg:-mt-4' },
      { label: 'LG Margin Top - (-S)', value: 'lg:-mt-2' },
      { label: 'LG Margin Top - (-XS)', value: 'lg:-mt-1' },
      { label: 'LG Margin Top - None', value: 'lg:mt-0' },
      { label: 'LG Margin Top - XS', value: 'lg:mt-1' },
      { label: 'LG Margin Top - S', value: 'lg:mt-2' },
      { label: 'LG Margin Top - M', value: 'lg:mt-4' },
      { label: 'LG Margin Top - L', value: 'lg:mt-6' },
      ...
      { label: 'LG Margin Top - 7XL', value: 'lg:mt-32' },
      { label: 'LG Margin Top - 8XL', value: 'lg:mt-40' },
      { label: 'Margin Bottom - (-8XL)', value: '-mb-40' },
      { label: 'Margin Bottom - 8XL', value: 'mb-40' },
      { label: 'MD Margin Bottom - (-8XL)', value: 'md:-mb-40' },
      { label: 'LG Margin Bottom - 8XL', value: 'lg:mb-40' },
      { label: 'Font Weight - Medium', value: 'font-medium' },
      { label: 'Font Weight - Semibold', value: 'font-semibold' },
      { label: 'Font Weight - Bold', value: 'font-bold' },
      { label: 'Font Weight - Extrabold', value: 'font-extrabold' },
      { label: 'Font Weight - Black', value: 'font-black' },
      { label: 'Font Family - Jost', value: 'font-jost' },
      { label: 'Font Family - Urbanist', value: 'font-urbanist' },
      { label: 'Font Family - Ubuntu', value: 'font-ubuntu' },
      { label: 'Font Family - Inter', value: 'font-inter' },
