...
const DownloadConfirmationPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#1e3a8a] text-white">
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        <div className="mb-4 flex items-center justify-center gap-4">
          ...
          <span className="inline-block font-semibold uppercase tracking-wide">THANK YOU</span>
        </div>
        <div className="max-w-2xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Your download is waiting for you in your inbox
          </h1>
          <p className="text-lg md:text-xl text-blue-200 mb-16 text-center">
            Need something more specific? Our team is ready to provide support, please select a
            service below
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 max-w-6xl mx-auto">
          {/* Contact Card */}
          <div className="bg-white text-black rounded-lg p-8 text-center col-span-2">
            ...
            <Link href="/contact">
              <button className="bg-blue-600 hover:bg-blue-900 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200">
                Contact us
              </button>
            </Link>
          </div>
          ...
          {/* Case Studies Card */}
          <div className="bg-white text-black rounded-lg p-8 text-center col-span-2 md:col-start-2 lg:col-start-auto">
            <div className="flex justify-center mb-6">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
